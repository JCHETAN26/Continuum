...
class EmbeddingUser(HttpUser):
    ...
    vocab = ["hello", "world", "this", "is", "a", "load", "test", "for", "continuum", "embeddings", "performance"]
    ...
    def embed_batch(self):
        ...
        headers = {
            ...
            "x-api-key": "continuum-secret-key"
        }
        ...
        with self.client.post("/v1/embed", data=json.dumps(payload), headers=headers, catch_response=True) as response:
