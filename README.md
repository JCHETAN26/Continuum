...
Serving latency is measured in CI: p50 of 202–299 ms at batch 1 and 10.9–14.0 s at batch
32 across two runs, against a spec target of p99 under 50 ms. The serving container is
capped at 0.50 CPU and every request pads to 256 tokens, which accounts for it; both are
